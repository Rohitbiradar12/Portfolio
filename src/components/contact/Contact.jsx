...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    // Send the user's message (Using the user template)
    emailjs
      .sendForm(
    ...
    // Send auto-reply (Using the auto-reply template)
    emailjs
      .send(
        import.meta.env.VITE_EMAILJS_SERVICE_ID,
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>rohitbiradar394@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
        ...
        >
          <svg width="450px" height="450px" viewBox="0 0 32.666 32.666">
            <motion.path
              ...
              l0.006-0.006c1.16,1.118,2.535,1.872,3.992,2.438l1.295-1.587c-1.426-0.631-2.848-1.507-4.244-2.747c-1.399-1.014-2.626-2.298-3.641-3.757c0.001,0-0.002-0.001-0.004-0.001L16.333,0z"
            />
          </svg>
        </motion.div>
